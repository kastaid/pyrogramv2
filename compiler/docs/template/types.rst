...
This page is about Pyrogram Types. All types listed here are available through the ``pyrogramv2.types`` package.
...
.. code-block:: python
    ...
    from pyrogramv2.types import User, Message, ...
...
.. currentmodule:: pyrogramv2.types
